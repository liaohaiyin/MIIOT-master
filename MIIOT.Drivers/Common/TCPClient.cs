...
namespace MIIOT
{
    ...
    public class TCPClientUtil
    {
        ...
        public void SendByPack( byte[] sendBuff)
        {
            ...
            {
                Log.WriteError("SendToServer", ex);
            }
        }
            ...
            while (true)
            {
                if (!socketClient.Connected)
                {
                    try
                    {
                        ...
                        Log.WriteDebug("TCP Connected");
                    }
                    catch (Exception ex)
                    {
                        //Log.WriteError("TCP Connect", ex);
                    }
                }
        ...
        private void UnPack(byte[] buff)
        {
            try
            {
                Log.WriteDebug("TCP Data>>" + buff.ByteToHexStr(" "));
