...
{
    public class pub_refund_dtl : BaseEntity, ISort
    {
        ...
        protected Int64 _refund_id;
        /// <summary>
        /// 申领表ID
        /// </summary>
        public virtual Int64 refund_id
        {
            get { return _refund_id; }
            set { _refund_id = value; OnPropertyChanged(nameof(refund_id)); }
        }
        ...
        protected int _refund_qty;
        /// <summary>
        /// 退货数量
        /// </summary>
        public virtual int refund_qty
        {
            get { return _refund_qty; }
            set { _refund_qty = value; OnPropertyChanged(nameof(refund_qty)); }
        }
