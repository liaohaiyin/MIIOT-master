...
{
    public class pub_apply_back_dtl : BaseEntity, ISort
    {
        ...
        protected Int64 _apply_back_id;
        /// <summary>
        /// 退货表ID
        /// </summary>
        public virtual Int64 apply_back_id
        {
            get { return _apply_back_id; }
            set { _apply_back_id = value; OnPropertyChanged(nameof(apply_back_id)); }
        }
        ...
        protected int _back_qty;
        /// <summary>
        /// 退货数量
        /// </summary>
        public virtual int back_qty
        {
            get { return _back_qty; }
            set { _back_qty = value; OnPropertyChanged(nameof(back_qty)); }
        }
        ...
        protected string _singlecode;
        /// <summary>
        /// 单品码
        /// </summary>
        public virtual string singlecode
        {
            get { return _singlecode; }
            set { _singlecode = value; OnPropertyChanged(nameof(singlecode)); }
        }

        protected string _back_reason;
        /// <summary>
        /// 原因
        /// </summary>
        public virtual string back_reason
        {
            get { return _back_reason; }
            set { _back_reason = value; OnPropertyChanged(nameof(back_reason)); }
        }
