// File:    pub_apply_back_dtl.cs
// Author:  si'a'zon
// Created: 2020年3月28日 18:15:59
// Purpose: Definition of Class pub_apply_back_dtl
...
public class pub_apply_back_dtl
{
   private long _id;
   /// <summary>
   /// id
   ...
   private long _apply_back_id;
   /// <summary>
   /// 退货表ID
   /// </summary>
   [JsonProperty]
   public long apply_back_id{
      get { return _apply_back_id; }
      set { _apply_back_id = value; }
   }
