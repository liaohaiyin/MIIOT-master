...
// Purpose: Definition of Class pub_pick
...
public class pub_pick
{
    ...
    private long _pick_person_id;
    /// <summary>
    /// 拣选人ID
    /// </summary>
    [JsonProperty]
    public long pick_person_id
    {
        get { return _pick_person_id; }
        set { _pick_person_id = value; }
    }
    private string _pick_person_name;
    /// <summary>
    /// 拣选人
    /// </summary>
    [JsonProperty]
    public string pick_person_name
    {
        get { return _pick_person_name; }
        set { _pick_person_name = value; }
    }
