...
{
	/// <summary>
	/// pub_store_out_dtl:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class pub_store_out_dtl
	{
		public pub_store_out_dtl()
		{ }
		#region Model
		private long _id;
		private long _organ_id = 0;
		private long _store_out_id;
		...
		/// 
		/// </summary>
		public long store_out_id
		{
			set { _store_out_id = value; }
			get { return _store_out_id; }
		}
		/// <summary>
		/// 
		/// </summary>
