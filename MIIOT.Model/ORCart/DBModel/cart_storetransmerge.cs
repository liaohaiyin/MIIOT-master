/**  版本信息模板在安装目录下，可自行修改。
* cart_storetransmerge.cs
*
* 功 能： N/A
* 类 名： cart_storetransmerge
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
...
{
	/// <summary>
	/// cart_storetransmerge:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class cart_storetransmerge
	{
		public cart_storetransmerge()
		{}
		#region Model
		private string _storetransmegerid;
		...
		/// 
		/// </summary>
		public string storetransmegerid
		{
			set{ _storetransmegerid=value;}
			get{return _storetransmegerid;}
		}
		/// <summary>
		/// 
		/// </summary>
