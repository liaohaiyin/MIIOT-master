/**  版本信息模板在安装目录下，可自行修改。
* sys_file_info_history.cs
*
* 功 能： N/A
* 类 名： sys_file_info_history
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2020/6/24 11:17:26   N/A    初版
*
...
{
	/// <summary>
	/// sys_file_info_history:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class sys_file_info_history
	{
		public sys_file_info_history()
		{}
		#region Model
