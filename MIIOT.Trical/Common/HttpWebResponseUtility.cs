...
namespace MIIOT.Trical.Common
{
    public class HttpWebResponseUtility
    {
        ...
        public async void test()
        {
            ...
            var requestUri = "https://store.uat.sunmi.com/openapi/product/getList";
           ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12 | SecurityProtocolType.Tls11 | SecurityProtocolType.Tls;

            var values = new[]
            {
               new KeyValuePair<string, string>("sunmi_shop_no","476934531001")
            ...
            //处理返回JSON数据
            var q = Newtonsoft.Json.JsonConvert.DeserializeObject<string>(res);
